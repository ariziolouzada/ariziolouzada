    ...
    public partial class newedit : Page
    {
        ...
        protected void btnVoltar_Click(object sender, EventArgs e)
        {
            ...
            if (Session["paremetrosDefault"].ToString() != string.Empty)
            {
                ...
                var paremetros = paremetrosDefault.ToString().Split(';');
                var data = paremetros[0];
                var tipo = int.Parse(paremetros[1]);
        ...
        {
            Response.Redirect("~/sbessencial/financeiro/fechamentodiario");
        ...
        protected void ddlTipo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            pnlServico.Visible = ddlTipo.SelectedValue.Equals("1");
        }
