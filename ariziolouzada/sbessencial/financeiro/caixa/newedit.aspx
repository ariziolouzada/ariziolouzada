<%@ Page Title="" Language="C#" MasterPageFile="~/sbessencial/sbessencial.Master" AutoEventWireup="true" CodeBehind="newedit.aspx.cs" Inherits="ariziolouzada.sbessencial.financeiro.caixa.newedit" %>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <asp:DropDownList ID="ddlTipo" runat="server"                                                                                                           class="chosen-select" style="width:350px;" tabindex="2" AutoPostBack="True" OnSelectedIndexChanged="ddlTipo_SelectedIndexChanged">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <asp:DropDownList ID="ddlCliente" runat="server"  class="chosen-select" style="width:350px;" tabindex="2">
                                    </asp:DropDownList>
                                </div>

                                <label class="col-sm-2 col-md-2 control-label">Forma Pgto:</label>
                                <div class="col-sm-4 col-md-4">
                                    <asp:DropDownList ID="ddlFormaPgto" runat="server"  class="chosen-select" style="width:350px;" tabindex="2">
                                        <asp:ListItem Value="0">Selecione...</asp:ListItem>
                                    ...
                                    <asp:DropDownList ID="ddlFormaPgtoDeposito" runat="server" Visible="false"  class="chosen-select" style="width:350px;" tabindex="2">
                                        <asp:ListItem Value="0">Selecione...</asp:ListItem>
                                        <asp:ListItem Value="1">Dinheiro</asp:ListItem>
                                        <asp:ListItem Value="5">Cheque</asp:ListItem>
                                        <asp:ListItem Value="6">Dinheiro e Cheque</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <asp:Panel ID="pnlTipoSaida" runat="server" Visible="false">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <asp:DropDownList ID="ddlTipoSaida" runat="server"  class="chosen-select" style="width:350px;" tabindex="2">
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <%-- AutoPostBack="True" OnSelectedIndexChanged="ddlServico_SelectedIndexChanged--%>
                                                <asp:DropDownList ID="ddlProduto" runat="server"  class="chosen-select" style="width:350px;" tabindex="2" onchange="selecaoDdlProduto()">
                                                </asp:DropDownList>
                            ...
                            <div class="form-group">
                                ...
                                <asp:Panel ID="pnlTotalCx" runat="server">
                                ...
                                <asp:Panel ID="pnlValorDeposito" runat="server" Visible="false">
                                    <label class="col-sm-2 col-md-2 control-label" style="color: #FF0000; font-weight: bold; font-size: 12pt;">Valor Depósito:</label>
                                    <div class="col-md-2 col-sm-2 ">
                                        <input type="text" class="form-control" runat="server" id="txtValorDeposito" style="color: #FF0000; font-weight: bold; font-size: 12pt;">
                                    </div>
                                    <label class="col-sm-1 col-md-1 control-label">BANCO</label>
                                    <div class="col-sm-2 col-md-2">
                                        <asp:DropDownList ID="ddlBancoDeposito" runat="server" class="form-control">
                                            <asp:ListItem Value="0">Selecione...</asp:ListItem>
                                            <asp:ListItem Value="2">CEF</asp:ListItem>
                                            <asp:ListItem Value="4">BANESTES</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </asp:Panel>
