<%@ Page Title="" Language="C#" MasterPageFile="~/sbessencial/sbessencial.Master" AutoEventWireup="true" CodeBehind="newedit.aspx.cs" Inherits="ariziolouzada.sbessencial.usuario.newedit" %>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h4>
                                <asp:Label ID="lblCabecalho" runat="server" Text="CADASTRAR USUÁRIO"></asp:Label></h4>
                        </div>
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-md-2 control-label">Login:</label>
                                <div class="col-sm-3 col-md-4">
                                    <input type="text" class="form-control" placeholder="Login" runat="server" id="txtLogin">
                                </div>
