...
namespace ast_cl
{
    public class Usuario
    {
        ...
        static Usuario()
        {
            StringConnection = ConfigurationManager.ConnectionStrings["ArizioLouzada.Properties.Settings.conectionString"].ConnectionString;
        }
        ...
        public static Usuario PesquisaDeCliente(int id)
        {
