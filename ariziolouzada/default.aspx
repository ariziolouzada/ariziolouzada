<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ariziolouzada._default" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="inSlider" class="carousel carousel-fade" data-ride="carousel">
            <ol class="carousel-indicators">
                <li class="active" data-slide-to="0" data-target="#inSlider"></li>
                <li data-slide-to="1" data-target="#inSlider"></li>
            </ol>
                ...
                <div class="item active">
                    <div class="container">
                        ...
                        <div class="carousel-image wow zoomIn">
                            <img alt="laptop" src="img/laptop.png" />
                        </div>
                    </div>
            ...
            <a class="left carousel-control" data-slide="prev" href="#inSlider" role="button">
                <span aria-hidden="true" class="glyphicon glyphicon-chevron-left"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="right carousel-control" data-slide="next" href="#inSlider" role="button">
        ...
        <section class="container features">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center  wow zoomIn">
                    <img alt="dashboard" class="img-responsive" src="img/perspective.png">
                </div>
            ...
            <div class="row features-block">
                ...
                <div class="col-lg-6 text-right wow fadeInRight">
                    <img alt="dashboard" class="img-responsive pull-right" src="img/dashboard.png">
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4 wow fadeInLeft">
                        <div class="team-member">
                            <img alt="" class="img-responsive img-circle img-small" src="img/avatar3.jpg">
                    ...
                    <div class="col-sm-4">
                        <div class="team-member wow zoomIn">
                            <img alt="" class="img-responsive img-circle" src="img/avatar1.jpg">
                    ...
                    <div class="col-sm-4 wow fadeInRight">
                        <div class="team-member">
                            <img alt="" class="img-responsive img-circle img-small" src="img/avatar2.jpg">
            ...
            <div class="container">
                ...
                <div class="row features-block">
                    ...
                    <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                        <img alt="dashboard" class="img-responsive" src="img/iphone.jpg">
                    </div>
                        ...
                        <div id="vertical-timeline" class="vertical-container light-timeline center-orientation">
                            <div class="vertical-timeline-block">
                                ...
                                <div class="vertical-timeline-content">
                                    ...
                                    <a class="btn btn-xs btn-primary" href="#">More info</a>
                ...
                <div class="row">
                    <div class="col-lg-4 wow zoomIn">
                        <ul class="pricing-plan list-unstyled">
                            <li class="pricing-title">Basic
                            </li>
                            <li class="pricing-desc">Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.
                            </li>
                    ...
                    <div class="col-lg-4 wow zoomIn">
                        <ul class="pricing-plan list-unstyled selected">
                            <li class="pricing-title">Standard
                            </li>
                            <li class="pricing-desc">Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.
                            </li>
                            <li class="pricing-price">
                    ...
                    <div class="col-lg-4 wow zoomIn">
                        <ul class="pricing-plan list-unstyled">
                            <li class="pricing-title">Premium
                            </li>
                            <li class="pricing-desc">Lorem ipsum dolor sit amet, illum fastidii dissentias quo ne. Sea ne sint animal iisque, nam an soluta sensibus.
                            </li>
                            <li class="pricing-price">
        ...
        <section id="contact" class="gray-section contact">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a class="btn btn-primary" href="mailto:test@email.com">Send us mail</a>
                        <p class="m-t-sm">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-center m-t-lg m-b-lg">
                        <p>
                            <strong>&copy; 2016 Arizio Louzada</strong><br />
        ...
        <div style="text-align: center;">
            <img alt="" src="img/em_construcao.png" />
            <br />
            <asp:Label ID="lblSaldacao" runat="server" Text="Label" style="font-weight: 700; color: #CC6600; font-size: x-large"></asp:Label>
