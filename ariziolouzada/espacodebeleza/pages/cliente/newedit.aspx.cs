        ...
        private bool VerificaCampos()
        {
            try
            {
                ...
                if (id.Equals("0"))
                {
                    ...
                    var clt = ClienteEspBel.Pesquisar(txtNome.Value, int.Parse(idEmpresaContratante));
                    if (clt != null)
                    {
                        txtNome.Focus();
                        ltlMsn.Text = "<div class=\"alert alert-block alert-danger fade in\"><button data-dismiss=\"alert\" class=\"close\" type=\"button\">×" +
        ...
        private bool SalvarDados()
        {
            try
            {
                var cliente = new ClienteEspBel()
                {
                    ...
                    LoginCadastro = sbessencial_cl.CookieSbe.Recupera("LoginUserLogado"),
                ...
                if (id.Equals("0"))
                {
                    ...
                    cliente.IdEmpresaContratante = int.Parse(idEmpresaContratante);

                    //Cadastro
                    if (!ClienteEspBel.Inserir(cliente))
                    {
                        ltlMsn.Text = "<div class=\"alert alert-block alert-danger fade in\"><button data-dismiss=\"alert\" class=\"close\" type=\"button\">X" +
                ...
                if (!ClienteEspBel.Editar(cliente))
                {
                    ltlMsn.Text = "<div class=\"alert alert-block alert-danger fade in\"><button data-dismiss=\"alert\" class=\"close\" type=\"button\">X" +
