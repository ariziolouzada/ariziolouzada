    ...
    public partial class _default : Page
    {
        ...
        private void CarregaTabela()
        {
            try
            {
                ...
                var lista = ClienteEspBel.Lista(false, txtPesquisa.Value, int.Parse(idEmpresaContratante));
                ...
                else
                {
                    ...
                    tabelaHtml.Append("<th style=\"text-align: center; vertical-align: middle;\">CPF</th>");
                    ...
                    foreach (var cliente in lista)
                    {
                        ...
                        //CPF                    
                        tabelaHtml.Append(string.Format("<td style=\"vertical-align: middle; text-align: center;\" >{0}</td>", cliente.Cpf));
