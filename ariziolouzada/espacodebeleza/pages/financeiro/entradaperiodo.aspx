<%@ Page Title="" Language="C#" MasterPageFile="~/espacodebeleza/espacobeleza.Master" AutoEventWireup="true" CodeBehind="entradaperiodo.aspx.cs" Inherits="ariziolouzada.espacodebeleza.pages.financeiro.entradaperiodo" %>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-2 col-sm-2  col-md-2" >
                                    <input type="date" class="form-control" runat="server" id="txtDataInicio" maxlength="10" />
                                </div>
                                ...
                                <div class="col-xs-1 col-sm-1 col-md-1">
                                    <asp:Button ID="btnFiltrar" runat="server" Text="Carregar" class="btn btn-success btn-rounded" OnClick="btnFiltrar_Click" />
                                    <%--&nbsp;Carregar &nbsp;Criar--%>
