<%@ Page Title="" Language="C#" MasterPageFile="~/espacodebeleza/espacobeleza.Master" AutoEventWireup="true" CodeBehind="newedit.aspx.cs" Inherits="ariziolouzada.espacodebeleza.pages.profissional.newedit" %>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
                                <label class="col-xs-2 col-sm-2 col-md-2 control-label">Telefone:</label>
                                ...
                                <div class="col-sm-4 col-md-4">
                                    <asp:DropDownList ID="ddlProfissao" runat="server" class="form-control">
                                    </asp:DropDownList>
                                </div>
                            </div>
