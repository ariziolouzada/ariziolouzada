    ...
    public partial class _default : Page
    {
        ...
        private void CarregaTabela()
        {
            try
            {
                ...
                var lista = ProfissionalEspBel.Lista(txtPesquisa.Value, int.Parse(idEmpresaContratante));
                ...
                else
                {
                    ...
                    foreach (var profissional in lista)
                    {
                        ...
                        //Profissional                    
                        tabelaHtml.Append(string.Format("<td style=\"vertical-align: middle; text-align: center\" >{0}</td>", profissional.Profissao));
